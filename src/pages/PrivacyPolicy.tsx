  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>Data Deletion and Retention</CardTitle>
          </CardHeader>
          <CardContent className="prose prose-sm max-w-none">
