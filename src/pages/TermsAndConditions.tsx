        ...
        <Card className="mb-6">
          <CardContent className="prose prose-sm max-w-none pt-6">
            <ol className="space-y-4">
              ...
              <li>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://rentalmycard.netlify.app/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</li>
              
              <li>The Platform is owned by CardRental, a company incorporated under the Companies Act, 1956 with its registered office at Agra, Agra, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</li>
              ...
              <li className="font-semibold">ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</li>
              ...
              <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Agra and Uttar Pradesh.</li>
